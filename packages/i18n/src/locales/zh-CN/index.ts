...
sklm: {
  ...
  mirrorCoding: {
    account: "账号",
    title: "MirrorCoding",
    description: "登录后，自动接入账号可用的模型与分组。",
    chooseDefault: "选择 MirrorCoding 默认模型",
    chooseDefaultDescription: "为新会话选择模型和分组。",
    chooseModel: "选择模型",
    chooseGroup: "选择分组",
    saveDefault: "保存默认设置",
    welcomeTitle: "连接 MirrorCoding",
    welcomeDescription: "在 PI-Desktop 中使用 MirrorCoding 模型。也可以稍后在「设置 → 账号」中登录。",
    skip: "暂时跳过",
    login: "使用 MirrorCoding 登录",
    cancel: "取消登录",
    reauthorize: "重新授权",
    switchAccount: "更换账号",
    logout: "退出账号",
    refresh: "刷新模型目录",
    retryRevocation: "重试服务端撤销",
    pendingRevocation: "本机已退出，服务端撤销未确认。",
    signed_out: "未登录",
    authorizing: "请在浏览器中完成授权…",
    connected: "已连接",
    reauthorizeStatus: "需要重新授权",
    expires: "授权期限",
    idle: "尚未同步",
    syncing: "正在同步模型…",
    success: "模型已同步",
    ...
    models: "{{count}} 个模型",
    empty: "此账号暂时没有可调用的模型。",
    confirmTitle: "停止 MirrorCoding 任务？",
    confirmDescription: "更换或退出账号将停止该账号正在运行的任务，其他服务商任务会继续运行。",
    confirm: "停止任务并继续",
    secure_storage_unavailable: "安全存储不可用，请启用系统凭证存储后重试。",
    credential_read_failed: "无法读取已保存的授权，请重新授权。",
    credential_write_failed: "无法保存授权，请检查磁盘访问权限后重新授权。",
    authorization_cancelled: "已取消授权。",
    authorization_timed_out: "授权已超时，请重试。",
    reauthorization_required: "授权已到期或已撤销，请重新授权。",
    network_error: "连接失败，请检查网络后重试。",
    catalog_failed: "无法同步模型，已保留上次同步的目录。",
    invalid_catalog: "服务端返回的模型目录无效。",
    token_exchange_failed: "未能完成授权，请重试。",
    invalid_token_response: "服务端返回的授权信息无效。",
    requestFailed: "操作失败，请重试。",
    model_or_group_unavailable: "此模型或分组已不可用，请重新选择。",
  },
  project: {
    open: "打开项目",
    openFolder: "打开文件夹",
