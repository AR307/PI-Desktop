...
"slashCommandSourceUnavailable": "La lista de comandos no está disponible, así que no se envió nada. Inténtalo de nuevo.",
    ...
    "backgroundSubagents_one": "{{count}} subagente ejecutándose en segundo plano",
    "backgroundSubagents_other": "{{count}} subagentes ejecutándose en segundo plano",
...
sklm: {
  ...
  "mirrorCoding": {
    "account": "Account",
    "title": "MirrorCoding",
    "description": "Sign in once to use your account's models and groups.",
    "chooseDefault": "Choose a MirrorCoding default",
    "chooseDefaultDescription": "Pick a model and group for new sessions.",
    "chooseModel": "Choose model",
    "chooseGroup": "Choose group",
    "saveDefault": "Save default",
    "welcomeTitle": "Connect to MirrorCoding",
    "welcomeDescription": "Use your MirrorCoding models in PI-Desktop. You can also connect later in Settings → Account.",
    "skip": "Skip for now",
    "login": "Sign in with MirrorCoding",
    "cancel": "Cancel sign-in",
    "reauthorize": "Authorize again",
    "switchAccount": "Change account",
    "logout": "Sign out",
    "refresh": "Refresh models",
    "retryRevocation": "Retry server sign-out",
    "pendingRevocation": "Signed out locally. Server revocation is not confirmed.",
    "signed_out": "Not signed in",
    "authorizing": "Complete authorization in your browser…",
    "connected": "Connected",
    "reauthorizeStatus": "Authorization required",
    "expires": "Authorization expires",
    "idle": "Not synchronized",
    "syncing": "Synchronizing models…",
    ...
    "models": "{{count}} models",
    "empty": "No callable models are available for this account.",
    "confirmTitle": "Stop MirrorCoding tasks?",
    "confirmDescription": "Changing or signing out of this account will stop its running tasks. Other providers will keep running.",
    "confirm": "Stop tasks and continue",
    ...
    "authorization_timed_out": "Authorization timed out. Please try again.",
    ...
    "catalog_failed": "Could not synchronize models. Your saved catalog is retained.",
    "invalid_catalog": "The server returned an invalid model catalog.",
    "token_exchange_failed": "Authorization could not be completed. Please try again.",
    "invalid_token_response": "The server returned an invalid authorization response.",
