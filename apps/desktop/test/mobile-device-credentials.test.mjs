...
test("mobile device identity is encrypted, account-scoped, and never restored from an ID alone", async () => {
  ...
  assert.deepEqual(await credentials.load("account-one"), { accountId: "account-one", deviceId: "desktop-one", deviceSecret: "secret-one" });
